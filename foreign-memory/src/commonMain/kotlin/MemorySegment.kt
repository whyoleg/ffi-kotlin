...
public sealed class MemorySegment {
    ...
    public abstract fun loadSegment(offset: MemoryAddressSize, segmentLayout: MemoryLayout): MemorySegment
    public abstract fun storeSegment(offset: MemoryAddressSize, segmentLayout: MemoryLayout, value: MemorySegment)

    public abstract fun view(offset: MemoryAddressSize, layout: MemoryLayout): MemorySegment

    public companion object {
        public val Empty: MemorySegment = TODO()
    }
}
