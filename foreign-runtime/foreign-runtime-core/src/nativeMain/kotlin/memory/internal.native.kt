...
internal actual fun createAutoMemoryAccess(): MemoryAccess = NativeMemoryAccess

@ForeignMemoryApi
internal actual fun createNullMemoryBlock(): MemoryBlock = NativeMemoryBlock.NULL
